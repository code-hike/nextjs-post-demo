...
const pr = id =>
  `https://github.com/pomber/ssg-demo/pull/${id}/files`

const files = {
  "01": {
    code: require(`!!raw-loader!./steps/01.package.jsonx`)
      .default,
    tabs: ["package.json"],
    file: "package.json",
    lang: "json",
    link: pr(
      "1/files#diff-b9cfc7f2cdf78a7f4b91a753d10865a2"
    ),
  },
  "02": {
    code: require(`!!raw-loader!./steps/02.index.js`)
      .default,
    tabs: ["package.json", "pages/index.js"],
    file: "pages/index.js",
    lang: "jsx",
    link: pr(
      "1/files#diff-e14ec8fd2b038fbccea5f8090d26ace4"
    ),
  },
  "04.index.js": {
    code: require("!!raw-loader!./steps/04.index.js")
      .default,
    lang: "jsx",
    file: "pages/index.js",
    tabs: ["package.json", "pages/index.js"],
  ...
  "05.index.js": {
    code: require("!!raw-loader!./steps/05.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "06.0.index.js": {
    code: require("!!raw-loader!./steps/06.0.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "07.index.js": {
    code: require("!!raw-loader!./steps/07.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "08.index.js": {
    code: require("!!raw-loader!./steps/08.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "09.0.index.js": {
    code: require("!!raw-loader!./steps/09.0.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "11.index.js": {
    code: require("!!raw-loader!./steps/11.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "12.index.js": {
    code: require("!!raw-loader!./steps/12.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "13.0.index.js": {
    code: require("!!raw-loader!./steps/13.0.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "13.1.index.js": {
    code: require("!!raw-loader!./steps/13.1.index.js")
      .default,
    tabs: ["package.json", "pages/index.js"],
    lang: "jsx",
    file: "pages/index.js",
  ...
  "14.country.js": {
    code: require("!!raw-loader!./steps/14.country.js")
      .default,
  ...
  "15.country.js": {
    code: require("!!raw-loader!./steps/15.country.js")
      .default,
    tabs: ["pages/index.js", "pages/country/[name].js"],
    lang: "jsx",
    file: "pages/country/[name].js",
  ...
  "16.country.js": {
    code: require("!!raw-loader!./steps/16.country.js")
      .default,
    tabs: ["pages/index.js", "pages/country/[name].js"],
    lang: "jsx",
    file: "pages/country/[name].js",
  ...
  "17.country.js": {
    code: require("!!raw-loader!./steps/17.country.js")
      .default,
    tabs: ["pages/index.js", "pages/country/[name].js"],
    lang: "jsx",
    file: "pages/country/[name].js",
...
const steps = p(
  ...
  s(
    "16",
    <MiniEditor
      step={{ ...files["15.country.js"], focus: "2:17" }}
    />,
    <MiniBrowser url="https://ssg-demo-klnt3u1pr.now.sh/country/Iran" />
  ),
  s(
  ...
  s(
    "18",
    <MiniEditor
      step={{ ...files["16.country.js"], focus: "19:27" }}
    />,
    <MiniBrowser url="https://ssg-demo-klnt3u1pr.now.sh/country/Iran" />
  ),
  s(
